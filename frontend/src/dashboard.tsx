    ...
    <h2>Dashboard</h2>
      ...
      { (data.battery || []).map((battery: any, idx: number) =>
        <div class="panel" key={idx}>
            { battery.i > 0.05 ?
              <div style="float: right; background: #1DB706; color: #ffffff; padding: 0.3rem 0.6rem 0.2rem; border-radius: 6px; font-size: 0.9rem; font-weight: 600; margin-left: 0.8rem">CHARGING</div>
              : battery.i < -0.05 ?
                <div style="float: right; background: #138cd2; color: #ffffff; padding: 0.3rem 0.6rem 0.2rem; border-radius: 6px; font-size: 0.9rem; font-weight: 600; margin-left: 0.8rem">DISCHARGING</div>
                :
                <div style="float: right; background: #3a516f; color: #ffffff; padding: 0.3rem 0.6rem 0.2rem; border-radius: 6px; font-size: 0.9rem; font-weight: 600; margin-left: 0.8rem">IDLE</div>
            }
