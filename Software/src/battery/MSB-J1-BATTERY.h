...
#define SELECTED_BATTERY_CLASS MsbJ1Battery

class MsbJ1Battery : public CanBattery {
 public:
...
#define DC_FASTCHARGE_LS2 0xC0
  ...
  CAN_frame MSB_17FC007B_poll = {.FD = true,  // OBD2 PID Poll requests
                                 .ext_ID = true,
                                 .DLC = 8,
                                 .ID = 0x17FC007B,
  ...
  CAN_frame MSB_5F5 = {.FD = true,
                       ...
                       .DLC = 8,
                       .ID = 0x5F5,
                       .data = {0xE7, 0x00, 0x85, 0x00, 0x1E, 0xCE, 0x08, 0x1E}};
  CAN_frame MSB_641 = {.FD = true,
                       .ext_ID = false,
                       .DLC = 8,
                       .ID = 0x641,
                       .data = {0x37, 0x18, 0x00, 0x00, 0xF0, 0x00, 0xAA, 0x70}};
  CAN_frame MSB_3C0 = {.FD = true,
                       .ext_ID = false,
                       .DLC = 4,
                       .ID = 0x3C0,
                       .data = {0x66, 0x00, 0x00, 0x00}};  // Klemmen_status_01
  CAN_frame MSB_1A555548 = {.FD = true,
                            .ext_ID = true,
                            .DLC = 8,
                            .ID = 0x1A555548,
                            .data = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
  CAN_frame MSB_1B000010 = {.FD = false,  // Not FD
                            .ext_ID = true,
                            .DLC = 8,
                            .ID = 0x1B000010,  // Gateway
                            .data = {0x00, 0x50, 0x08, 0x50, 0x01, 0xFF, 0x30, 0x00}};
  CAN_frame MSB_153 = {.FD = true,
                       .ext_ID = false,
                       .DLC = 8,
  ...
  CAN_frame MSB_5E1 = {.FD = true,
                       ...
                       .data = {0x87, 0x2A, 0x00, 0x60, 0xFE, 0x00, 0x00, 0x00}};
  CAN_frame MSB_3BE = {.FD = true,
                       .ext_ID = false,
                       .DLC = 8,
                       .ID = 0x3BE,  // CRC, otherwise content
                       .data = {0x27, 0x0D, 0x93, 0x00, 0x00, 0x02, 0x00, 0x80}};
  CAN_frame MSB_503 = {.FD = true,  //HVK_01
                       .ext_ID = false,
                       .DLC = 8,
