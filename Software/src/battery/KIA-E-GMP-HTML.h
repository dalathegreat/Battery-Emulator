...
class KiaEGMPHtmlRenderer : public BatteryHtmlRenderer {
 public:
  KiaEGMPHtmlRenderer(DATALAYER_INFO_KIAEGMP* dl) : kia_datalayer(dl) {}

  String get_status_html() {
    String content;

    auto print_hyundai = [&content](DATALAYER_INFO_KIAEGMP& data) {
 ...
 private:
  DATALAYER_INFO_KIAEGMP* kia_datalayer;
};
