...
CAN_frame TESLA_3A1 = {.FD = false,
    ...
    uint8_t frame6_3A1[16] = {0xD0,0xE2,0xF0,0x02,0x10,0x22,0x30,0x42,0x50,0x62,0x70,0x82,0x90,0xA2,0xB0,0xC2};
    uint8_t frame7_3A1[16] = {0x01,0xCB,0x21,0xEB,0x41,0x0B,0x61,0x2B,0x81,0x4B,0xA1,0x6B,0xC1,0x8B,0xE1,0xAB};
