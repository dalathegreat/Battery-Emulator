...
#define PID_44 0xD492  //Unknown
  ...
  //old .data = {0x7D, 0x00, 0x4E, 0x20, 0x00, 0x00, 0x90, 0x0D}};
  CAN_frame ECMP_110 = {.FD = false,
                        .ext_ID = false,
                        .DLC = 8,
                        .ID = 0x110,
                        .data = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x87, 0x05}};
  //old .data = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4E, 0x20}};
  ...
  CAN_frame ECMP_17B = {.FD = false,
                        ...
                        .DLC = 8,
                        .ID = 0x17B,
                        .data = {0x00, 0x00, 0x00, 0x7E, 0x78, 0x00, 0x00, 0x0F}};
  ...
  //TODO, removed this 3D0 during testing
  ...
  CAN_frame ECMP_372 = {.FD = false,
                        ...
                        .DLC = 8,
                        .ID = 0x372,
                        .data = {0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
  ...
  CAN_frame ECMP_794 = {.FD = false,
                        ...
                        .DLC = 8,
                        .ID = 0x794,
                        .data = {0xB8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}};
  //.data = {0x38, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}};
  ...
  uint8_t data_3A2_CRC[16] = {0x0C, 0x1B, 0x2A, 0x39, 0x48, 0x57, 0x66, 0x75, 0x84, 0x93, 0xA2, 0xB1};
  /*  int8_t data_3A2_CRC[16] = {0x08, 0x17, 0x26, 0x35, 0x44, 0x53, 0x62, 0x71,
                              0x80, 0x9F, 0xAE, 0xBD, 0xCC, 0xDB, 0xEA, 0xF9};*/
  uint8_t data_345_content[16] = {0x04, 0xF5, 0xE6, 0xD7, 0xC8, 0xB9, 0xAA, 0x9B,
