...
extern uint16_t user_selected_daly_power_per_percent;
extern uint16_t user_selected_daly_power_per_dV;
extern uint16_t user_selected_daly_power_per_dV_start;
extern uint16_t user_selected_daly_power_per_degree_C;
extern uint16_t user_selected_daly_power_at_0_degree_C;
