...
// See TESLA-ALERT-NAMES.h. Names from tesla-m3-pack-findings (firmware 2019.20.4.2).
const char* const TESLA_BMS_ALERT_NAMES[100] = {
...
const char* const TESLA_PCS_ALERT_NAMES[94] = {
...
const char* const TESLA_CP_ALERT_NAMES[96] = {
    "CP_a001_canRx",
    "CP_a002_canTx",
    "CP_a003_canError",
