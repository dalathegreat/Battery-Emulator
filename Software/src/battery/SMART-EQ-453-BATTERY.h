...
class SmartEq453Battery : public CanBattery {
 ...
 private:
  ...
  // ── CAN frames ──────────────────────────────────────────────────────────
  CAN_frame frame_634_wake = {.FD = false,
                              .ext_ID = false,
                              .DLC = 4,
                              .ID = 0x634,
                              .data = {.u8 = {0x40, 0x00, 0x00, 0x00}}};

  CAN_frame frame_634_awake = {.FD = false,
                               .ext_ID = false,
                               .DLC = 4,
                               .ID = 0x634,
                               .data = {.u8 = {0x80, 0x00, 0x32, 0x00}}};

  CAN_frame frame_diag_request = {.FD = false,
                                  .ext_ID = false,
                                  .DLC = 8,
                                  .ID = 0x79B,
                                  .data = {.u8 = {0x02, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}};

  CAN_frame frame_diag_request_22 = {.FD = false,
                                     .ext_ID = false,
                                     .DLC = 8,
                                     .ID = 0x79B,
                                     .data = {.u8 = {0x03, 0x22, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00}}};

  CAN_frame frame_flow_control = {.FD = false,
                                  .ext_ID = false,
                                  .DLC = 8,
                                  .ID = 0x79B,
