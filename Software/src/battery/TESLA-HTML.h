...
class TeslaHtmlRenderer : public BatteryHtmlRenderer {
 public:
  String get_status_html() {
    ...
    float PCS_dcdcTemp = static_cast<float>(datalayer_extended.tesla.PCS_dcdcTemp);
    float PCS_ambientTemp = static_cast<float>(datalayer_extended.tesla.PCS_ambientTemp);
    float PCS_chgPhATemp = static_cast<float>(datalayer_extended.tesla.PCS_chgPhATemp);
    float PCS_chgPhBTemp = static_cast<float>(datalayer_extended.tesla.PCS_chgPhBTemp);
    float PCS_chgPhCTemp = static_cast<float>(datalayer_extended.tesla.PCS_chgPhCTemp);
