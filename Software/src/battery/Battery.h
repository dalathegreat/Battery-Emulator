...
class Battery {
 public:
  ...
  virtual float get_charge_line_current_A() { return 0.0f; }
  virtual float get_charge_line_power_W() { return 0.0f; }
  virtual float get_charge_line_current_limit_A() { return 0.0f; }
