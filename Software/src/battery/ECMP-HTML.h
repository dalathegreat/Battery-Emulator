...
class EcmpHtmlRenderer : public BatteryHtmlRenderer {
  ...
  String get_status_html() {
    ...
    auto print_ecmp = [&content](DATALAYER_INFO_ECMP& data) {
      ...
      content += "<h4>Average cell voltage: " +
                 ...
                 " mV</h4>";
      content += "<h4>High precision current: " +
      ...
      content +=
          "<h4>12V: " +
          (datalayer_extended.stellantisECMP.pid_12v == 255 ? "N/A"
      ...
      content +=
          "<h4>Remember to press Open Contactors from main menu before running the dianostic commands below:</h4>";
    };
 ...
 private:
  DATALAYER_INFO_ECMP* ecmp_datalayer;
};
