#ifndef DYNESS_BATTERY_H
#define DYNESS_BATTERY_H
...
class DynessBattery : public CanBattery {
 public:
  ...
  DynessBattery(DATALAYER_BATTERY_TYPE* datalayer_ptr, bool* contactor_closing_allowed_ptr, CAN_Interface targetCan)
      : CanBattery(targetCan, CAN_Speed::CAN_SPEED_500KBPS) {
  ...
  static constexpr const char* Name = "Dyness Tower";

 private:
  static const int MAX_CELL_DEVIATION_MV = 150;
  static const int MAX_CELLS = 180;                           // Maximum cells supported
  static const uint32_t EMUS_BASE_ID = 0x19B50000;            // EMUS extended ID base for cell count
  static const uint32_t CELL_VOLTAGE_BASE_ID = 0x18FF9701;    // Base CAN ID for cell voltages
