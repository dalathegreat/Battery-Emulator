...
void BoltAmperaBattery::update_values() {
  ...
  for (int i = 0; i < 96; i++) {
    ...
    if (cv > actual_max_mV)
      actual_max_mV = cv;
    if (cv > 0 && cv < actual_min_mV)
      actual_min_mV = cv;  // cv > 0 ignores empty cells
  }
  ...
  float current_temps[6] = {battery_module_temp_1, battery_module_temp_2, battery_module_temp_3,
...
void BoltAmperaBattery::handle_incoming_can_frame(CAN_frame rx_frame) {
  ...
  switch (rx_frame.ID) {
    ...
    case 0x3E3:  // THIS MUST WORK
      ...
      Serial.printf("!!! 3E3 FOUND !!! Max: %.1f, Min: %.1f\n", (float)temperature_highest_C,
                    (float)temperature_lowest_C);
      break;
    ...
    case 0x7EF:  // Reply from VITM
      ...
      if (reply_poll_7E7 == POLL_7E7_MODULE_TEMP_1)
        battery_module_temp_1 = (rx_frame.data.u8[4] / 2.0f) - 40;
      if (reply_poll_7E7 == POLL_7E7_MODULE_TEMP_2)
        battery_module_temp_2 = (rx_frame.data.u8[4] / 2.0f) - 40;
      if (reply_poll_7E7 == POLL_7E7_MODULE_TEMP_3)
        battery_module_temp_3 = (rx_frame.data.u8[4] / 2.0f) - 40;
      if (reply_poll_7E7 == POLL_7E7_MODULE_TEMP_4)
        battery_module_temp_4 = (rx_frame.data.u8[4] / 2.0f) - 40;
      if (reply_poll_7E7 == POLL_7E7_MODULE_TEMP_5)
        battery_module_temp_5 = (rx_frame.data.u8[4] / 2.0f) - 40;
      if (reply_poll_7E7 == POLL_7E7_MODULE_TEMP_6)
        battery_module_temp_6 = (rx_frame.data.u8[4] / 2.0f) - 40;
      break;
...
void BoltAmperaBattery::calculateBalancing() {
  ...
  if (printNow) {
    ...
    for (int i = 0; i < 12; i++)
      Serial.printf("%02X ", balanceMask[i]);
    Serial.println("\n======================");
  }
}
...
void BoltAmperaBattery::transmit_can(unsigned long currentMillis) {
  ...
  if (currentMillis - previousMillis778 >= 20) {
    ...
    heartbeat.ID = 0x778;
    heartbeat.DLC = 7;
    heartbeat.data.u8[0] = 0x00;
    heartbeat.data.u8[1] = 0x31;
    heartbeat.data.u8[2] = 0x00;
    heartbeat.data.u8[3] = 0x00;
    heartbeat.data.u8[4] = 0x00;
    heartbeat.data.u8[5] = 0x00;
  ...
  if (currentMillis - previousMillis305 >= 100) {
    ...
    frame_305.ID = 0x305;
    frame_305.DLC = 8;
    frame_305.data.u8[0] = 0x60;
    frame_305.data.u8[1] = 0x00;
    frame_305.data.u8[2] = 0x02;
    frame_305.data.u8[3] = 0x58;
    frame_305.data.u8[4] = 0x11;
    frame_305.data.u8[5] = 0x94;
    frame_305.data.u8[6] = 0x05;
    frame_305.data.u8[7] = 0xDC;
  ...
  if (currentMillis - previousMillis307 >= 100) {
    ...
    frame_307.ID = 0x307;
    frame_307.DLC = 8;
    frame_307.data.u8[0] = 0xCC;
    frame_307.data.u8[1] = 0x20;
    frame_307.data.u8[2] = 0x00;
    frame_307.data.u8[3] = 0x00;
    frame_307.data.u8[4] = 0xFF;
    frame_307.data.u8[5] = 0x04;
    frame_307.data.u8[6] = 0x00;
    frame_307.data.u8[7] = 0x00;
  ...
  if (currentMillis - previousMillis460 >= 500) {
    ...
    frame_460.ID = 0x460;
    frame_460.DLC = 4;
    frame_460.data.u8[0] = 0x0A;
    frame_460.data.u8[1] = 0x1C;
    frame_460.data.u8[2] = 0x00;
    frame_460.data.u8[3] = 0x00;
  ...
  if (currentMillis - previousMillis_obc >= 100) {
    ...
    CAN_frame f304;
    memset(&f304, 0, sizeof(CAN_frame));
    f304.ID = 0x304;
    f304.DLC = 4;
    transmit_can_frame_to_interface(&f304, CAN_NATIVE);

    CAN_frame f306;
    memset(&f306, 0, sizeof(CAN_frame));
    f306.ID = 0x306;
    f306.DLC = 8;
    ...
    CAN_frame f309;
    memset(&f309, 0, sizeof(CAN_frame));
    f309.ID = 0x309;
    f309.DLC = 8;
    ...
    CAN_frame f314;
    memset(&f314, 0, sizeof(CAN_frame));
    f314.ID = 0x314;
    f314.DLC = 8;
    f314.data.u8[0] = 0x0F;
    f314.data.u8[6] = 0xB0;
    ...
    CAN_frame f316;
    memset(&f316, 0, sizeof(CAN_frame));
    f316.ID = 0x316;
    f316.DLC = 3;
