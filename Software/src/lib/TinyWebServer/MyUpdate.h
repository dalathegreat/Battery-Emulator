...
#ifndef MYESP32UPDATER_H
#define MYESP32UPDATER_H
...
#define SPI_SECTORS_PER_BLOCK 8 //16  // usually large erase block is 32k/64k
...
public:
  ...
  /*
    ...
    */
  MyUpdateClass &onProgress(THandlerFunction_Progress fn);
