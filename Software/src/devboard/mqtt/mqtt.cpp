...
static const SensorConfig batterySensorConfigTemplate[] = {
    ...
    {"leaf_hx", TrKey::MQTT_LEAF_HX, "%", "", supports_leaf_metrics}};
...
static const SensorConfig globalSensorConfigTemplate[] = {
    ...
    {"software_version", TrKey::MQTT_EMULATOR_VERSION, "", "", always},
    {"heap_free", TrKey::MQTT_HEAP_FREE, "B", "data_size", heap_metrics_enabled},
    {"heap_max_block", TrKey::MQTT_HEAP_MAX_BLOCK, "B", "data_size", heap_metrics_enabled},
    {"heap_min_free", TrKey::MQTT_HEAP_MIN_FREE, "B", "data_size", heap_metrics_enabled},
    {"heap_fragmentation", TrKey::MQTT_HEAP_FRAGMENTATION, "%", "", heap_metrics_enabled}};
