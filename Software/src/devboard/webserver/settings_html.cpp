...
<div style='background-color: #404E47; padding: 10px; margin-bottom: 10px; border-radius: 50px'>
    ...
    <div style='background-color: #2D3F2F; padding: 10px; margin-bottom: 10px;border-radius: 50px'>
      ...
      <h4 data-h=maxchga>Max charge speed: %MAX_CHARGE_SPEED% A </span> <button onclick='editMaxChargeA()'>Edit</button></h4>

      <h4 data-h=maxdchga>Max discharge speed: %MAX_DISCHARGE_SPEED% A </span><button onclick='editMaxDischargeA()'>Edit</button></h4>
...
const char settings_html[] = INDEX_HTML_HEADER COMMON_JAVASCRIPT SETTINGS_STYLE SETTINGS_HTML_BODY SETTINGS_HTML_SCRIPTS
    HELP_SCRIPT INDEX_HTML_FOOTER;
