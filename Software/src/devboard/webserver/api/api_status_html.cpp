...
String api_status_processor() {
  ...
  addJsonNumber(json, "max_discharge_current", static_cast<float>(datalayer.battery.status.max_discharge_current_dA) / 10.0);
  ...
  addJsonNumber(json, "cell_delta", datalayer.battery.status.cell_max_voltage_mV - datalayer.battery.status.cell_min_voltage_mV);
  ...
  addJsonNumber(json, "cell_delta", datalayer.battery2.status.cell_max_voltage_mV - datalayer.battery2.status.cell_min_voltage_mV);
