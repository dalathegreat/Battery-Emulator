...
void init_webserver() {
  ...
  const char* boolSettingNames[] = {
      "DBLBTR",        "CNTCTRL",       "CNTCTRLDBL",   "PWMCNTCTRL",    "PERBMSRESET",    "STATICIP",
      "REMBMSRESET",   "EXTPRECHARGE",  "USBENABLED",   "CANLOGUSB",     "WEBENABLED",     "WIFIAPENABLED",
      "MQTTENABLED",   "NOINVDISC",     "HADISC",       "MQTTCELLV",     "GTWRHD",         "DIGITALHVIL",
      "PERFPROFILE",   "INTERLOCKREQ",  "SOCESTIMATED", "PYLONOFFSET",   "PYLONORDER",     "DEYEBYD",
      "NCCONTACTOR",   "TRIBTR",        "CNTCTRLTRI",   "ESPNOWENABLED", "PRIMOGEN24",     "CTINVERT",
      "LOWPASSFILTER", "WEBAUTH",       "SLOWCANINV",   "CHGTAPERSOC",   "MEASURECPUTEMP", "SYSLOGEN",
      "PERBMSDEFSOC",  "PERBMSSKIPBAL", "INVOFFGRID",   "CHGESTIMATED",  "MQTTHEAP",       "HADISCFWU",
      "UUGP_ALLOW",    "SYSLOGEN",      "PERBMSDEFSOC", "PERBMSSKIPBAL", "INVOFFGRID",     "CHGESTIMATED",
      "MQTTHEAP",      "HADISCFWU",     "INVACCREB",
#ifdef SDCARD
  ...
  const char* uintSettingNames[] = {
      ...
      "SYSLOGFAC",  "PERBMSRESETH", "UUGP_PWRLIM",   "UUGP_DSOC",     "UUGP_STARTMODE"};
