...
<div class="event-log">
<div class="event" style="background-color: #1E2C33; font-weight: bold;">
    <div>Event Type</div>
    <div>Severity</div>
    <div>Last Event</div>
    <div>Count</div>
...
<style> // This section makes each element alternate betweeen two colors
...
content.concat("<div class='last-event-seconds-ago'>" + String((millis() / 1000) - entries[i].timestamp) + "</div>");
...
content.concat("<div class='timestamp' style='display:none;'>" + String(entries[i].timestamp) + "</div>");
