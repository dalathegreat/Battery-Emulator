...
std::vector<BatteryCommand> battery_commands = {
    ...
    {"startOfflineBalancing", "Start Offline Balancing", 
      "Please charge battery fully for this to work. After a couple of minutes, battery will sleep and do balancing. It often takes many hours. There will be no progress indication and Battery Emulator status will be red. Continue?",
