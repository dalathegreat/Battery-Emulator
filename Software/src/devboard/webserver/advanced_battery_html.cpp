...
std::vector<BatteryCommand> battery_commands = {
    ...
    {"calibrateSOC", "Calibrate SOC", "calibrate SOC? Note this will reset SOC to 100percent",
    ...
    {"startOfflineBalancing", "Balancing",
     ...
     [](Battery* b) { return b && b->supports_offline_balancing() && !b->is_offline_balancing_active(); },
     [](Battery* b) { b->initiate_offline_balancing(); }},
    {"endOfflineBalancing", "Stop Balancing Mode", "end offline balancing?",
     [](Battery* b) { return b && b->supports_offline_balancing() && b->is_offline_balancing_active(); },
     [](Battery* b) { b->end_offline_balancing(); }},
