...
#define EVENTS_ENUM_TYPE(XX)            \
  ...
  XX(EVENT_CAN_CONTROLLER_MISSING)      \
  XX(EVENT_BATTERY_NODE_MISSING)        \
  XX(EVENT_BATTERY_NODE_WARNING)        \
  XX(EVENT_BATTERY_NODE_FAULT)          \
  XX(EVENT_BATTERY_NODE_IDENT_MISMATCH) \
  XX(EVENT_BATTERY_NODE_STATUS_STALE)   \
