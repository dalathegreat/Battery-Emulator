...
#define EVENTS_ENUM_TYPE(XX)            \
  ...
  XX(EVENT_CAN_MASTER_MISSING)          \
  XX(EVENT_SLAVE_BATTERY_MISSING)       \
  XX(EVENT_SLAVE_WARNING)               \
  XX(EVENT_SLAVE_FAULT)                 \
  XX(EVENT_SLAVE_IDENT_MISMATCH)        \
  XX(EVENT_SLAVE_STATUS_STALE)          \
