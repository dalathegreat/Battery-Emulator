...
#define EVENTS_ENUM_TYPE(XX)               \
  ...
  XX(EVENT_AUTO_BALANCE_START)             \
  XX(EVENT_AUTO_BALANCE_CONTACTORS_OPEN)   \
  XX(EVENT_AUTO_BALANCE_CONTACTORS_CLOSED) \
  XX(EVENT_AUTO_BALANCE_STOP)              \
  XX(EVENT_AUTO_BALANCE_RETRY)             \
  XX(EVENT_AUTO_BALANCE_ERROR)             \
  XX(EVENT_NOF_EVENTS)
