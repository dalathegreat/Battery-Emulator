...
/* NOTE ON THE PER-BATTERY EVENTS BELOW
   ...
   there is no noun to inflect in names like EVENT_12V_LOW. Pack 1 keeps its exact original name
   in every case, so existing MQTT/ESP-NOW consumers and event-page filters keep working.
...
#define EVENTS_ENUM_TYPE(XX)                 \
  ...
  XX(EVENT_BALANCING_END_BAT2)               \
  XX(EVENT_BALANCING_END_BAT3)               \
  XX(EVENT_12V_LOW)                          \
  XX(EVENT_12V_LOW_BAT2)                     \
  XX(EVENT_12V_LOW_BAT3)                     \
  XX(EVENT_HVIL_FAILURE)                     \
  XX(EVENT_HVIL_FAILURE_BAT2)                \
  XX(EVENT_HVIL_FAILURE_BAT3)                \
  XX(EVENT_CONTACTOR_WELDED)                 \
  XX(EVENT_CONTACTOR_WELDED_BAT2)            \
  XX(EVENT_CONTACTOR_WELDED_BAT3)            \
  XX(EVENT_CONTACTOR_OPEN)                   \
  XX(EVENT_CONTACTOR_OPEN_BAT2)              \
  XX(EVENT_CONTACTOR_OPEN_BAT3)              \
  XX(EVENT_WATER_INGRESS)                    \
  XX(EVENT_WATER_INGRESS_BAT2)               \
  XX(EVENT_WATER_INGRESS_BAT3)               \
  XX(EVENT_THERMAL_RUNAWAY)                  \
  XX(EVENT_THERMAL_RUNAWAY_BAT2)             \
  XX(EVENT_THERMAL_RUNAWAY_BAT3)             \
  XX(EVENT_INTERNAL_OPEN_FAULT)              \
  XX(EVENT_INTERNAL_OPEN_FAULT_BAT2)         \
  XX(EVENT_INTERNAL_OPEN_FAULT_BAT3)         \
  XX(EVENT_STALE_VALUE)                      \
  XX(EVENT_STALE_VALUE_BAT2)                 \
  XX(EVENT_STALE_VALUE_BAT3)                 \
  XX(EVENT_SOC_UNAVAILABLE)                  \
  XX(EVENT_SOC_UNAVAILABLE_BAT2)             \
  XX(EVENT_SOC_UNAVAILABLE_BAT3)             \
  XX(EVENT_KWH_PLAUSIBILITY_ERROR)           \
  XX(EVENT_KWH_PLAUSIBILITY_ERROR_BAT2)      \
  XX(EVENT_KWH_PLAUSIBILITY_ERROR_BAT3)      \
  XX(EVENT_PID_FAILED)                       \
  XX(EVENT_PID_FAILED_BAT2)                  \
  XX(EVENT_PID_FAILED_BAT3)                  \
  XX(EVENT_RJXZS_LOG)                        \
  XX(EVENT_RJXZS_LOG_BAT2)                   \
  XX(EVENT_RJXZS_LOG_BAT3)                   \
  XX(EVENT_BMS_RESET_REQ_SUCCESS)            \
  XX(EVENT_BMS_RESET_REQ_SUCCESS_BAT2)       \
  XX(EVENT_BMS_RESET_REQ_SUCCESS_BAT3)       \
  XX(EVENT_BMS_RESET_REQ_FAIL)               \
  XX(EVENT_BMS_RESET_REQ_FAIL_BAT2)          \
  XX(EVENT_BMS_RESET_REQ_FAIL_BAT3)          \
  XX(EVENT_BYD_AUTO_SOC_CALIBRATION)         \
  XX(EVENT_BYD_AUTO_SOC_CALIBRATION_BAT2)    \
  XX(EVENT_BYD_AUTO_SOC_CALIBRATION_BAT3)    \
  XX(EVENT_BYD_CHARGE_TERMINATED)            \
  XX(EVENT_BYD_CHARGE_TERMINATED_BAT2)       \
  XX(EVENT_BYD_CHARGE_TERMINATED_BAT3)       \
  XX(EVENT_BYD_CONTACTOR_MISMATCH)           \
  XX(EVENT_BYD_CONTACTOR_MISMATCH_BAT2)      \
  XX(EVENT_BYD_CONTACTOR_MISMATCH_BAT3)      \
  XX(EVENT_BYD_CONTACTOR_FORCE_OPEN)         \
  XX(EVENT_BYD_CONTACTOR_FORCE_OPEN_BAT2)    \
  XX(EVENT_BYD_CONTACTOR_FORCE_OPEN_BAT3)    \
  XX(EVENT_BYD_CONTACTOR_OPEN_REQ)           \
  XX(EVENT_BYD_CONTACTOR_OPEN_REQ_BAT2)      \
  XX(EVENT_BYD_CONTACTOR_OPEN_REQ_BAT3)      \
  XX(EVENT_BYD_CONTACTOR_CLOSE_REQ)          \
  XX(EVENT_BYD_CONTACTOR_CLOSE_REQ_BAT2)     \
  XX(EVENT_BYD_CONTACTOR_CLOSE_REQ_BAT3)     \
