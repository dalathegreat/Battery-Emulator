...
void init_events(void) {
  ...
  events.entries[EVENT_SOC_WINDOW_INVALID].level = EVENT_LEVEL_WARNING;
...
String get_event_message_string(EVENTS_ENUM_TYPE event) {
  switch (event) {
    ...
    case EVENT_SOC_WINDOW_INVALID:
      return "Stored SOC min/max is not a valid pair. Running with defaults, see data for stored min percent";
