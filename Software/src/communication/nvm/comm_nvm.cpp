...
void init_stored_settings() {
  ...
  // Load everything declared in the settings tables (webserver_settings.cpp),
  ...
  // The charge taper band is derived from the edited start-SOC setting.
  charge_taper_band_pptt = 10000 - charge_taper_start_soc * 100;
...
void store_settings() {
  ...
  // TARGETCHVOLT/TARGETDISCHVOLT, BMSRESETDUR).
