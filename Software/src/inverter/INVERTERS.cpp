...
uint16_t charge_taper_start_soc = 95;  // NVM value; the band below is derived from it at boot
...
uint16_t charge_taper_floor_W =
    400;  //Minimum charge power in W held during tapering until 100.00% scaled SOC. 0 = disabled, taper goes linearly to 0W
