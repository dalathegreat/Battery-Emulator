...
struct DATALAYER_BATTERY_STATUS_TYPE {
  ...
  /** Tesla DC-DC 12V voltage in deciVolts. 142 = 14.2 V */
  uint16_t dcdc_12v_voltage_dV = 0;
  ...
  /** Tesla DC-DC 12V current in deciAmpere. 65 = 6.5 A */
  int16_t dcdc_12v_current_dA = 0;
