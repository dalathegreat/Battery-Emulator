...
{ //This function maps all the values fetched from battery CAN to the correct CAN messages
  ...
  //BMS_Limits
  SOLAX_1872.data.u8[0] = (uint8_t) max_volt_solax_can; 
  SOLAX_1872.data.u8[1] = (max_volt_solax_can >> 8);
  SOLAX_1872.data.u8[2] = (uint8_t) min_volt_solax_can;
  ...
  //BMS_PackData
  SOLAX_1873.data.u8[0] = (uint8_t) battery_voltage;
  ...
  SOLAX_1873.data.u8[6] = (uint8_t) (remaining_capacity_Wh/10); 
  SOLAX_1873.data.u8[7] = ((remaining_capacity_Wh/10) >> 8);

  //BMS_CellData
  SOLAX_1874.data.u8[0] = (uint8_t) (temperature_max*10); 
  SOLAX_1874.data.u8[1] = ((temperature_max*10) >> 8);
  SOLAX_1874.data.u8[2] = (uint8_t) (temperature_min*10); 
  SOLAX_1874.data.u8[3] = ((temperature_min*10) >> 8);
  SOLAX_1874.data.u8[4] = (uint8_t) (cell_max_voltage/100); 
  SOLAX_1874.data.u8[5] = ((cell_max_voltage/100) >> 8); 
  SOLAX_1874.data.u8[6] = (uint8_t) (cell_min_voltage/100); 
  SOLAX_1874.data.u8[7] = ((cell_min_voltage/100) >> 8);

  //BMS_Status
  SOLAX_1875.data.u8[0] = (uint8_t) (temperature_average*10); 
  SOLAX_1875.data.u8[1] = ((temperature_average*10) >> 8);
  SOLAX_1875.data.u8[2] = (2); // Contactor, 0=off, 2=on //Todo, base on what variable?


  //BMS_PackTemps (strange name, since it has voltages?)
  SOLAX_1876.data.u8[2] = (uint8_t) cell_max_voltage; 
  SOLAX_1876.data.u8[3] = (cell_min_voltage >> 8);

  SOLAX_1876.data.u8[6] = (uint8_t) cell_min_voltage;
