...
volatile float CHARGER_SET_HV = 112;      // Reasonably appropriate 4.0v per cell charging of a 96s pack
volatile float CHARGER_MAX_HV = 115;      // Max permissible output (VDC) of charger
volatile float CHARGER_MIN_HV = 96;      // Min permissible output (VDC) of charger
volatile float CHARGER_MAX_POWER = 4000;  // Max power capable of charger, as a ceiling for validating config
volatile float CHARGER_MAX_A = 40;      // Max current output (amps) of charger
