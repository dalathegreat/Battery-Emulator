...
- Follow the [installation guidelines](https://dalathegreat.github.io/Battery-Emulator-Wiki/setup/installation_guidelines/) section for how to install and commission your battery properly :notebook: 
...
For examples showing wiring, see each battery type's own Wiki page. For instance the [Nissan LEAF page](https://dalathegreat.github.io/Battery-Emulator-Wiki/battery/nissan_leaf_e_nv200/)
